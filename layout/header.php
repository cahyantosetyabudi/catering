...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">SUSUNDAAN KITCHEN</a>
        </div>
   ...
   <?php } ?>
	...
	<div class="row">
		<div class="col-md-3">
			<div style="background:#000000; width:100%; height:auto; padding-top:3px;padding-bottom:3px; padding-left:10px;">
			...
			<div style="background:#000000; width:100%; height:auto; padding-top:3px;padding-bottom:3px; padding-left:10px; 	margin-bottom:15px;">
			...
			<div class="row col-md-12">
				<hr>
				<img src="<?php echo $url.'uploads/logo.png'; ?>" width="200" height="200"><br><br>
			</div>
		</div>